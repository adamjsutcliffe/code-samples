...
namespace Peak.QuixelLogic.Scripts.Game
{
    ...
    public sealed class QualityController : MonoBehaviour
    {
        ...
        {
            if (PlayerPrefs.HasKey(GameConstants.SettingKeys.QualitySettingsEnabled))
            {
                QualitySettings.SetQualityLevel(PlayerPrefs.GetInt(GameConstants.SettingKeys.QualitySettingsEnabled), true);
            ...
            PlayerPrefs.SetInt(GameConstants.SettingKeys.QualitySettingsEnabled, QualitySettings.GetQualityLevel());
        ...
        public string ToggleQuality()
        {
            ...
            PlayerPrefs.SetInt(GameConstants.SettingKeys.QualitySettingsEnabled, (int)nextLevel);
